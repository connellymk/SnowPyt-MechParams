    ...
    return [
        ...
        *[
            MethodSpec(
                ...
                function=lambda density, grain_form, include_method_uncertainty=True, method_name=method_name: calculate_elastic_modulus(
                    method_name,
                    density=density,
                    grain_form=grain_form,
                    include_method_uncertainty=include_method_uncertainty,
                ...
                citation=method_name,
            )
            for method_name in ("bergfeld", "kochle", "wautier", "schottner")
        ],
        MethodSpec(
