"""Methods to calculate Poisson's ratio (ν) of a snow layer.
...
def _calculate_poissons_ratio_kochle(
    ...
    - Although MF grain types were included in the study, and the results are
      shown in fig. 4, the authors did not provide the mean Poisson's ratio
      values for this grain type.
