...
def test_create_slabs_layer_of_concern_handles_uncertain_depths_without_warning():
    ...
    layers = [
        Layer(
            depth_top=ufloat(0.0, 0.2),
            thickness=ufloat(10.0, 0.5),
            layer_of_concern=False,
        ),
        Layer(
            depth_top=ufloat(10.0, 0.2),
            thickness=ufloat(5.0, 0.25),
            layer_of_concern=True,
        ),
        Layer(
            depth_top=ufloat(15.0, 0.2),
...
def test_create_slabs_raises_error_for_invalid_weak_layer_def(
    mock_snowpylot_profile_with_layers,
):
